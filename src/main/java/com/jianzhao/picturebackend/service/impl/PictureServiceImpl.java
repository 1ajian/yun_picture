...
import com.jianzhao.picturebackend.api.aliyunai.model.CreateOutPaintingTaskRequest;
...
import com.jianzhao.picturebackend.manager.capture.BatchCaptureImagesFromBaidu;
import com.jianzhao.picturebackend.manager.upload.FilePictureUpload;
import com.jianzhao.picturebackend.manager.upload.PictureUploadTemplate;
import com.jianzhao.picturebackend.manager.upload.UrlPictureUpload;
import com.jianzhao.picturebackend.mapper.PictureMapper;
import com.jianzhao.picturebackend.model.dto.file.UploadPictureResult;
...
import com.jianzhao.picturebackend.utils.ColorSimilarUtils;
...
public class PictureServiceImpl extends ServiceImpl<PictureMapper, Picture>
    ...
    @Resource
    private BatchCaptureImagesFromBaidu batchCaptureImagesFromBaidu;
...
//            }
            ...
            if (space.getTotalCount() >= space.getMaxCount()) {
                throw new BusinessException(ErrorCode.OPERATION_ERROR, "空间的图片过多");
            }
...
//            }
        ...
        List<String> names = response.getRecognitionResult().stream().map(Label::getName)
                .filter(label -> !"哺乳动物".equals(label))
...
//        }
        ...
        //解析分类并赋值给图片
        List<String> categories = uploadPictureResult.getCategories();
        pictureVO.setCategories(categories);
        return pictureVO;
    }
    ...
    public Integer uploadPictureByBatch(PictureUploadByBatchRequest pictureUploadByBatchRequest, User loginUser) {
        ...
        String fetchUrl = String.format("https://cn.bing.com/images/async?q=%s&first=%s&mmasync=1", pictureUploadByBatchRequest.getSearchText(),begin);
